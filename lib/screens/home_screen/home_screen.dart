...
import 'package:travel_app_paralax_effect_flutter/screens/home_screen/components/top_destinations/top_destinations.dart';
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            ...
            style: TextStyle(
                color: kSecondaryColor.withOpacity(0.6), fontSize: 16),
          )
        ],
      ),
    );
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 36),
            const TopDestinations(padding: _padding, spacing: _spacing),
          ],
        ),
      ),
    );
